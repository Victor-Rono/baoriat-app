<template>
  ...
  <div class="" v-show="!visible">
    ...
    >
      <q-carousel-slide
        name="first"
        img-src="https://images.pexels.com/photos/1486785/pexels-photo-1486785.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
      >
        <div class="absolute-bottom custom-caption">
          <div class="text-h6">
            <q-icon name="fas fa-home" size="md" /><br />
            {{ this.ctgr }}
          </div>
  ...
  <div class="row justify-center q-mt-md q-mb-sm" v-if="!visible">
    <u class="text-h5 text-grey"
      ...
      <y class="text-primary text-bold"> Sale/Renting</y></u
    >
  </div>
