<template>
  ...
  <div class="" v-show="!visible">
    ...
    >
      <q-carousel-slide
        name="first"
        img-src="https://images.unsplash.com/photo-1486328228599-85db4443971f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"
      >
        <div class="absolute-bottom custom-caption">
          <div class="text-h6">
            <q-icon name="fas fa-seedling" size="md" /><br />
            {{ this.ctgr }}
          </div>
  ...
  <div class="row justify-center q-mt-md q-mb-sm" v-if="!visible">
    <u class="text-h5 text-grey"
      ><y class="text-primary">{{ this.ctgr }} For</y>
